                                ...
                                <div class="row" id="product-gallery">
                                    @if($productImages->isNotEmpty())
                                        ...
                                        <input type="hidden" name="image_array[]" value ="{{ $image->id }}">
                                            ...
                                            <div class="card-body">
                                                <a href="javasript:void(0)" onclick="deleteImage({{ $image->id }})" class="btn btn-danger">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
...
Dropzone.autoDiscover = false;    
    const dropzone = $("#image").dropzone({ 
        ...
        <input type="hidden" name="image_array[]" value ="${response.image_id}">
            ...
            <div class="card-body">
                <a href="javasript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Delete</a>
                 </div>
            </div></div>`;
